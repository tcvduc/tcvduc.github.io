(function () {
  ...
  function formElementOnsubmit(formElement, searchElement, mainElement) {
    formElement.onsubmit =
      ...
      async function (event) {
        ...
        if (searchTerm && searchTerm !== "") {
          const movies = await getMovies(SEARCH_API + searchTerm);
  ...
  async function main() {
    ...
    showMovies(movies, mainElement);
    formElementOnsubmit(formElement, searchElement, mainElement);
  }
